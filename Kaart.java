...
public class Kaart {
	...
	public Kaart() {
		...
		Locatie locatie4 = new Locatie("top", "Je staat op de top van de berg. Je hebt een prachtig uitzicht.\n"
				+ "In het zuiden zie je de monding van een rivier. Je kunt afdalen naar het westen en opstijgen naar een wolk.");
		locatie3.verbind('o', locatie4);
		locatie4.verbind('w', locatie3);
				
		Locatie locatie5 = new Locatie("wolk", "Je staat op een wolk. Je bent verbaasd dat je er niet doorheen valt.\n"
				+ "Onder je zie je de berg waaruit de rivier ontspringt. Je kunt afdalen naar de top van de berg.");
		locatie5.verbind('d', locatie4);
		locatie4.verbind('u', locatie5);
	}
